...
export default defineNuxtConfig({
  ...
  css: [
    "@fontsource-variable/rokkitt/wght.css",
    "@fontsource/gelasio/400.css",
    "@fontsource/gelasio/400-italic.css",
    "@fontsource/gelasio/700.css",
  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { name: "theme-color", content: "#2B50C8" },
        {
          content:
